...
SECRET_KEY = 'django-insecure-6g&&k#6%qkg^j12$9*3so5_$4gdwnuyho!bm+$rtz4%kh7l$f3'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(days=5*360),
    "REFRESH_TOKEN_LIFETIME": timedelta(days=6*360),
